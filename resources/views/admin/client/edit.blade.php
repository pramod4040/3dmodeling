  ...
  <div class="row">
      <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            ...
            <form method="post" action="{{route('client.update', $data->id)}}"  id="slider-form" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" value="{{$data->name}}" name="name" id="country-name" placeholder="Enter Client Name">
              ...
              <div class="form-group col-md-6">
                  ...
                  <br>
                  <img src="/uploads/client/{{$data->logo}}" alt="preview image" id="output1" height="150px" width="150px"> <br>
                  {!!$errors->first('logo', '<span class="text-danger has-error">:message</span>')!!}
              </div>

              <div class="form-group col-md-6">
                <label for="exampleInputEmail1">Link</label>
                <input type="text" class="form-control" value="{{$data->link}}" name="link" id="country-name" placeholder="Enter Client's Website/link">
