...
<h2 class="page-header">Edit Award </h2>
  ...
  <div class="row">
      <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            ...
            <form method="post" action="{{route('award.update', $data->id)}}"  id="slider-form" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" value="{{$data->name}}" name="name" id="country-name" placeholder="Enter Award Name">
              ...
              <div class="form-group col-md-6">
                  ...
                  <br>
                  <img src="/uploads/award/{{$data->image}}" alt="preview image" id="output" height="150px" width="150px"> <br>
